...
//  static final int CF_ACTION_UNUSED           = 2;
    ...
    /* hounjini added */
//    void requestResetWSIMState(Message message);
//    void requestISIMRead(int i, int j, int k, int l, int i1, Message message);
//    void requestQueryISIMSupported(Message message);
	void requestSetISIMAUTH(String s, Message message);
