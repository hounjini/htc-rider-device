...
/*
    ...
    {
		Log.d("wimax >> iccard", "requestISIMRead() : requestISIMRead called" + i + "," + j + "," + k + "," + l+ "," + i1);
        mPhone.mCM.requestISIMRead(i, j, k, l, i1, message);
		Log.d("wimax >> iccard", "requestISIMRead() : requestISIMRead finished" + i + "," + j + "," + k + "," + l+ "," + i1);
    }

    public void requestQueryISIMSupported(Message message)
    {
		Log.d("wimax >> iccard", "requestQueryISIMSupported() : requestQueryISIMSupported called");
        mPhone.mCM.requestQueryISIMSupported(message);
		Log.d("wimax >> iccard", "requestQueryISIMSupported() : requestQueryISIMSupported finished");
    }

    public void requestResetWSIMState(Message message)
    {
	    Log.d("wimax >> iccard", "requestResetWSIMState() : requestResetWSIMState called");
        mPhone.mCM.requestResetWSIMState(message);
	    Log.d("wimax >> iccard", "requestResetWSIMState() : requestResetWSIMState finished");
    }
*/
    public void requestSetISIMAUTH(String s, Message message)
    {
        mPhone.mCM.requestSetISIMAUTH(s, message);
    }
