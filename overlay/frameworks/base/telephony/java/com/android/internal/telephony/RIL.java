 ...
 * You may obtain a copy of the License atriljLog
 *
...
/* hounjini added */
			case RIL_REQUEST_SET_ISIM_AUTH: ret = responseString(p); break;
/*
			case RIL_REQUEST_RESET_WSIM_STATE:
Log.d("wiamx >> RIL.java", "processSolicited() : RIL_REQUEST_RESET_WSIM_STATE");
			ret = responseString(p); break;
			case RIL_REQUEST_ISIM_READ:
			Log.d("wiamx >> RIL.java", "processSolicited() : RIL_REQUEST_ISIM_READ");
			 ret = responseString(p); break;
			case RIL_REQUEST_QUERY_ISIM_SUPPORTED:
			Log.d("wiamx >> RIL.java", "processSolicited() : RIL_REQUEST_QUERY_ISIM_SUPPORTED");
...
/* hounjini added */
		    case RIL_REQUEST_SET_ISIM_AUTH: return "RIL_REQUEST_SET_ISIM_AUTH";
/*
    		case RIL_REQUEST_RESET_WSIM_STATE: return "RIL_REQUEST_RESET_WSIM_STATE";
			case RIL_REQUEST_ISIM_READ: return "RIL_REQUEST_ISIM_READ";
			case RIL_REQUEST_QUERY_ISIM_SUPPORTED: return "RIL_REQUEST_QUERY_ISIM_SUPPORTED";
*/
...
*/
    ...
    /* hounjini added */
    public void requestSetISIMAUTH(String s, Message message)
    {
        RILRequest rilrequest = RILRequest.obtain(526, message);
        rilrequest.mp.writeString(s);
        send(rilrequest);
    }
/*    
    public void requestResetWSIMState(Message message)
    {
		Log.d("wimax >> RIL.java", "requestResetWSIMState() : requestResetWSIMState");
        RILRequest rilrequest = RILRequest.obtain(545, message);
		Log.d("wimax >> RIL.java", rilrequest.serialString() + "> " + requestToString(rilrequest.mRequest));
        send(rilrequest);
		Log.d("wimax >> RIL.java", "requestResetWSIMState() : requestResetWSIMState - send done");
    }
   
    public void requestISIMRead(int i, int j, int k, int l, int i1, Message message)
    {
		Log.d("wimax >> RIL.java", "requestISIMRead() : requestISIMRead");
        RILRequest rilrequest = RILRequest.obtain(527, message);
		...
		Log.d("wimax >> RIL.java",  rilrequest.serialString() + "> " + requestToString(rilrequest.mRequest));
        send(rilrequest);
        Log.d("wimax >> RIL.java", "requestISIMRead() : requestISIMRead - send done");
    }
    
    public void requestQueryISIMSupported(Message message)
    {
		Log.d("wimax >> RIL.java", "requestQueryISIMSupported() : requestQueryISIMSupported");
        RILRequest rilrequest = RILRequest.obtain(528, message);
		Log.d("wimax >> RIL.java", rilrequest.serialString() + "> " + requestToString(rilrequest.mRequest));
        send(rilrequest);
        Log.d("wimax >> RIL.java", "requestQueryISIMSupported() : requestQueryISIMSupported - send done");
    }
*/   
}
